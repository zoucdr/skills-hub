---
name: product-launch-reveal-video-gen
version: 1.0.0
description: "Generate product launch reveal videos with WeryAI—premium authority, precision lighting, dramatic feature moments, black-stage sweeps for keynote-style drops. Use when you need precision push, explode-orbit around product, top-down press, black seamless with sweep beams; hybrid tech score, keynote pulse beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [product-launch, keynote, reveal, tech, premium, black-stage, sweep-light, hybrid, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Product launch & premium keynote reveal video

**Product launch video** in one line: **black void**, **blade of light**, **hero product levitation feel**, **feature callouts** in light only—**keynote mood** without copying real brands.

**Style anchor tag (optional in user briefs):** `product_launch_reveal_video`.

## Use when

- **Product launch**, **premium reveal**, **precision lighting**, **dramatic feature showcase**, **keynote style**.
- Text or **single image-to-video**.

**Not this skill:** **messy vlog kitchen** default or **horror**—unless ironic brief.
...
- **Look & grade:** **matte black cyclorama**, **sharp beam sweep**, **specular trail** on edges, **UI glow** accents generic.
- **Camera grammar (pick 1–2):** **precision dolly**; **explode-orbit** describing separation of parts (stylized); **top-down** hero lock.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**hybrid tech** pulse, **sub drop** on reveal, **wide riser**—generic keynote bed.

**Style anchors:** *product launch, premium reveal, precision lighting, dramatic feature showcase, keynote style, product_launch_reveal_video.*
...
- Do **not** mimic **trademarked keynote stages** or **real product** trade dress; user supplies **generic** or **owned** design language.


### Example prompts

- `16:9 black stage phone hero—product_launch_reveal_video, sweep light, precision push, hybrid tech bed`
- `Exploded orbit parts—dramatic feature showcase, sub drop generic`
- `Top-down product lock—keynote style, matte black`
- `Animate hero still—reveal beam (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `messy bedroom vlog, flat fluorescent office only, watermark` |
...
## Scenario: Text-to-video product launch reveal
...
## Scenario: Image-to-video product launch reveal
...
> Skill: `product-launch-reveal-video-gen`.
