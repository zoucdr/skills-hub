---
name: "fairytale-dream-transform-video-gen-seedance2.0"
version: 1.0.0
description: "Soften any idea into creamy pastel dreamscapes: gentle bloom, cute proportion cues, sugar-glow particles—WeryAI Seedance 2.0 only. Use when you need healing cute fantasy, cotton-candy skies, or wholesome vertical reels. SEO: fairytale dream video; pastel healing short video."

tags: [fairytale, pastel, dreamy, cute, short-video, video-gen]

metadata: { "openclaw": { "emoji": "🍬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Fairytale dream & candy-soft style transform (Seedance 2.0)

**Cotton-memory look:** cream and candy gradients, soft global light, micro sparkles and petals, buoyant motion, airy audio bed when on.
...
- **Cream palette:** blush, mint, butter yellow—high key but not clipped.
- **Soft space:** rounded shapes, bokeh bubbles, gentle fog pastel.
- **Cute subject read:** big-eye friendly, kind expressions—respect reference photo likeness.
- **Details:** sugar crystals, petals, tiny fairies of light—sparse and tasteful.
- **Motion:** floaty, ease-in-out; avoid harsh snap unless comedic beat.
- **Sound (if on):** music-box hints, soft bells—whispery and kind.
...
- `City commute → pastel cloud floor, gentle petals, slow glide, vertical`
- `Baking cookies → oversized candy props, warm sparkle dust, cozy macro`
- `HTTPS couple photo → same pose, dream haze, floating heart motes (subtle)`
...
> Generated for skill `fairytale-dream-transform-video-gen-seedance2.0`.
