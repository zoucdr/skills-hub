---
name: extreme-action-video-gen
version: 1.0.0
description: "Generate extreme action videos with WeryAI—adrenaline rush, wide-angle distortion, high-speed POV for skate, surf, sky, and off-road energy. Use when you need helmet POV, rapid turns, ground-hugging follow, dive moves; punk rock, drum and bass, or hard EDM beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [extreme, action, POV, adrenaline, skate, surf, wide-angle, DnB, EDM, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Extreme action & adrenaline POV video

**Extreme action video** in one line: **visceral speed**, **barrel distortion**, **wind slap**, **near-miss obstacles**, and **heartbeat pacing**—**thrill**, not calm travel vlog.

**Style anchor tag (optional in user briefs):** `extreme_action_video`.

## Use when

- **Extreme action**, **adrenaline rush**, **high speed POV**, **wide angle distortion**, **thrilling intensity**.
- Text or **single image-to-video**.

**Not this skill:** **slow emotional poetry** default or **studio product**—unless user wants contrast.
...
- **Look & grade:** **ultra-wide** feel, **splash**, **dust rooster**, **motion streaks**.
- **Camera grammar (pick 1–2):** **helmet POV**; **whip pan** on turn; **ground follow** inches from wheels; **aerial dive** language (generic, no unsafe instructions).
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**punk rock** drive, **drum and bass** rollers, **hard EDM** drops—generic.

**Style anchors:** *extreme action, adrenaline rush, wide angle distortion, high speed POV, thrilling intensity, extreme_action_video.*
...
- Do **not** instruct **illegal** stunts or **real-person** reckless imitation; keep prompts **stylized and generic**.


### Example prompts

- `POV skate hill bomb—extreme_action_video, wide distortion, wind roar bed, DnB generic`
- `Surf tube glimpse—salt spray, adrenaline rush, hard EDM pulse`
- `Dirt bike roost—ground follow, punk rock bed`
- `Animate board still—POV wobble (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `static interview, soft piano only, watermark` |
...
## Scenario: Text-to-video extreme action
...
## Scenario: Image-to-video extreme action
...
> Skill: `extreme-action-video-gen`.
