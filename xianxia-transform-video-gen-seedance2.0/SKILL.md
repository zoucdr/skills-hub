---
name: "xianxia-transform-video-gen-seedance2.0"
version: 1.0.0
description: "Translate any brief into xianxia / Chinese fantasy aesthetic: mountain mist, pavilion architecture, flowing robes, spiritual light ribbons—WeryAI Seedance 2.0 only. Use when you need wuxia-xianxia shorts, guqin mood, or image-to-video with immortal-energy VFX language. SEO: xianxia video; Chinese fantasy short video."

tags: [xianxia, chinese-fantasy, wuxia, oriental, short-video, video-gen]
...
# Chinese xianxia fantasy style transform (Seedance 2.0)
...
- **Architecture:** curved eaves, stone steps, bamboo bridge—depth for 9:16.
- **Costume cues:** layered hanfu-inspired drape, hair ribbons—respect user intent if modern→fantasy.
- **Body method:** light footwork, sleeve waves, controlled spins.
- **Spirit light:** soft cyan-gold ribbons, not laser spam.
- **Ambience:** fog banks, cherry or peach petals, distant waterfalls.
- **Sound (if on):** guqin / xiao flavor words—no specific recordings named.

**Fits:** Guofeng beauty, cultivation fantasy teasers, travel spots reimagined as jianghu.
...
- `Hiking trail → turns to misty immortal peak path, ribbon light, slow crane feel`
- `Meditation clip → lotus pond reflection, golden dust motes, vertical`
- `HTTPS portrait → add subtle qi glow around hands, bamboo bokeh`
...
> Generated for skill `xianxia-transform-video-gen-seedance2.0`.
