---
name: fantasy-fairytale-video-gen
version: 1.0.0
description: "Generate fantasy fairytale videos with WeryAI—magical glow, dreamy forest, particles, mist, whimsical light for fairy-tale and feminine fantasy content. Use when you need orbit, gentle crane, slow push, floaty drift; new-age harp, fairy-tale score beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [fantasy, fairytale, magical, forest, whimsical, enchanted, harp, dreamy, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Fantasy fairytale & magical enchantment video

**Fantasy fairytale video** in one line: **spark motes**, **velvet fog**, **storybook palette**, **gentle levitation feel**—**wonder**, not urban grit.

**Style anchor tag (optional in user briefs):** `fantasy_fairytale_video`.

## Use when

- **Fantasy fairytale**, **magical glow**, **dreamy forest**, **enchanted atmosphere**, **whimsical light**.
- Text or **single image-to-video**.

**Not this skill:** **cyberpunk neon city** default or **documentary vérité**—unless mashup.
...
- **Look & grade:** **soft bloom**, **particle glitter**, **moss and bark** read, **pastel or jewel** light.
- **Camera grammar (pick 1–2):** **orbit** around figure; **slow crane** through branches; **floating drift** language.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**harp** arpeggio, **new-age pad**, **fairy-tale motif**—generic.

**Style anchors:** *fantasy fairytale, magical glow, dreamy forest, enchanted atmosphere, whimsical light, fantasy_fairytale_video.*
...
- `Enchanted grove—fantasy_fairytale_video, orbit, spark motes, harp bed generic`
- `Mist path slow push—whimsical light, enchanted atmosphere`
- `Floating lantern feel—gentle crane, magical glow`
- `Animate costume still—dreamy forest motion (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `gritty urban street, flat office, watermark` |
...
## Scenario: Text-to-video fantasy fairytale
...
## Scenario: Image-to-video fantasy fairytale
...
> Skill: `fantasy-fairytale-video-gen`.
