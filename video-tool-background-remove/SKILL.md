...
**Dependencies:** `scripts/video_background_remove.js` (self-contained CLI), `WERYAI_API_KEY`, Node.js 18+.
...
Full parameter matrix and enums: For the full matrix, open the **`weryai-video-toolkits`** skill package `references/video-tools-matrix.md`, or run `node scripts/video_background_remove.js spec` from this package.
