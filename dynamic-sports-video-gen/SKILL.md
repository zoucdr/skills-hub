---
name: dynamic-sports-video-gen
version: 1.0.0
description: "Generate dynamic sports videos with WeryAI—high energy, sweat sheen, muscle tension, sharp action detail for gym, run, ball sports, and training content. Use when you need run-along, low tracking, fast push, whip cuts, slow-motion accents; trap, rock, or hybrid percussion beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [sports, fitness, athletic, gym, running, action, energy, trap, percussion, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Dynamic sports & kinetic power video

**Dynamic sports video** in one line: **explosive acceleration**, **impact freeze-feel**, **sweat sparkles**, **muscle fiber read**, and **percussive cutting**—**power**, not sleepy drama.

**Style anchor tag (optional in user briefs):** `dynamic_sports_video`.

## Use when

- **Dynamic sports**, **high energy**, **kinetic motion**, **athletic training**, **sharp action detail**.
- Text or **single image-to-video**.

**Not this skill:** **slow meditative abstract** default or **static product turntable**—unless user wants hybrid.
...
- **Look & grade:** **hard side light**, **stadium or gym** practicals, **motion blur** on limbs when fast.
- **Camera grammar (pick 1–2):** **run parallel**; **low tracking**; **snap zoom** on lift; **slow-motion accent** on landing (describe in prompt).
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**trap** hats, **rock** downbeats, **hybrid percussion** impacts—generic.

**Style anchors:** *dynamic sports, high energy, kinetic motion, sharp action detail, powerful athletic vibe, dynamic_sports_video.*
...
- Do **not** depict **unsafe stunts** or **real athletes** by name without user clearance; keep **generic** sports description.


### Example prompts

- `9:16 sprint track—dynamic_sports_video, low tracking, sweat sheen, trap hats generic`
- `Gym deadlift—fast push on lockout, hybrid percussion hits`
- `Basketball drive—whip cut on crossover, rock bed`
- `Animate training still—run-along (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `sleepy drama static frame, pastel vlog only, watermark` |
...
## Scenario: Text-to-video dynamic sports
...
## Scenario: Image-to-video dynamic sports
...
> Skill: `dynamic-sports-video-gen`.
