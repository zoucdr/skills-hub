#!/usr/bin/env node
/** WeryAI video-watermark-remove — this skill only. */
...
const TOOL = {
  ...
  preparePayload(p) {
    if (p.rects && p.rect_vo_list == null) p.rect_vo_list = p.rects;
  },
};
...
mainSync(process.argv.slice(2), TOOL, "video_watermark_remove.js");
