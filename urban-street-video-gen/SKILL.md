---
name: urban-street-video-gen
version: 1.0.0
description: "Generate urban street videos with WeryAI—raw city texture, signage layers, streetwear attitude, grain or punchy contrast, and fast rhythm for youth culture content. Use when you need walk-follow, fast lateral pan, low tracking, whip transitions; hip-hop, boom bap, trap, or city beats; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [urban, street, streetwear, youth, hip-hop, grain, motion, city, culture, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Urban street & youth culture video

**Urban street video** in one line: **gritty pavement read**, **layered signage**, **streetwear silhouette**, **kinetic pace**, and **filmic grain or crushed contrast**—**street culture** energy, not polished studio catalog.

**Style anchor tag (optional in user briefs):** `urban_street_video`.

## Use when

- Someone asks for **urban street**, **raw city texture**, **streetwear attitude**, **fast urban rhythm**, **youth energy**.
- **Text-to-video** or **image-to-video** (single reference still) with **9:16**, **16:9**, or **1:1**.
- Users mention **walk-and-talk follow**, **whip pan**, **low-angle tracking**, **boom bap** or **trap** mood.

**Not this skill:** **pastoral travel epic** default, **quiet minimalist** gallery, or **wedding soft romance** as the primary look—unless the user explicitly overrides.
...
- **Look & grade:** **visible grain** or **clean digital sharp** per user; **punchy contrast**; **neon signage bokeh** (generic glyphs, no real brand logos); **wet or dry asphalt** texture.
- **Subject:** **hoodie silhouette**, **sneaker stride**, **bodega awning**, **subway mouth**—urban cues without trademarked locations unless user owns rights.
- **Composition:** **Dutch tilt** optional; **foreground pass** of railing or bike; **leading lines** from crosswalks.
- **Camera grammar (pick 1–2):** **walk-follow** matching cadence; **fast lateral whip** to next beat; **low-angle tracking** along curb.
- **Audio (mandatory when `generate_audio` is true):** labeled **`Audio:`** block—**boom bap** drums, **trap** hi-hats, **sub 808** pulse, **city bed**—generic, no named tracks. If the user wants **silent** video: set **`generate_audio`: `false`** and omit audio from the prompt; state that in the confirmation table.

**Style anchors (weave naturally):** *urban street, raw city texture, youth energy, streetwear attitude, fast urban rhythm, urban_street_video.*

**Length:** Stay within **`prompt_length_limit` 2000**; trim before losing motion and grit read.
...
- `9:16 night corner store—urban_street_video, walk-follow, neon bokeh, grain, trap hats and sub pulse generic`
- `Low-angle tracking past sneakers—fast urban rhythm, whip to wide, boom bap bed`
- `Alley signage layers—raw city texture, streetwear attitude, handheld energy`
- `16:9 boulevard—lateral pan fast, youth energy, city foley`
- `Animate this fit pic—walk-follow, urban street mood (image URL in JSON)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `pastel cottage, quiet gallery minimalism, soft wedding romance, watermark` |
...
## Scenario: Text-to-video urban street
...
## Scenario: Image-to-video urban street
