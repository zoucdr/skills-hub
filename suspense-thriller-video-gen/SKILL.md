---
name: suspense-thriller-video-gen
version: 1.0.0
description: "Generate suspense thriller videos with WeryAI—hidden details, cold color cast, claustrophobic framing, slow reveal for mystery and psychological tension. Use when you need creeping push, voyeur drift, long-lens pull, corner-follow; suspense score, low pulse, dark drone beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [suspense, thriller, tension, mystery, psychological, cold, dark, drone, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Suspense thriller & psychological unease video

**Suspense thriller video** in one line: **shadow swallowing edges**, **partial information**, **slow creep**, **uncomfortable negative space**—**unease**, not jump-scare horror primary unless user asks.

**Style anchor tag (optional in user briefs):** `suspense_thriller_video`.

## Use when

- **Suspense thriller**, **hidden details**, **cold tension**, **claustrophobic framing**, **psychological unease**.
- Text or **single image-to-video**.

**Not this skill:** **bright campus comedy** default or **luxury gloss product**—unless hybrid.
...
- **Look & grade:** **teal bias**, **lifted noise shadows**, **practicals barely on**.
- **Camera grammar (pick 1–2):** **peeking slow push**; **long lens** compress hallway; **corner creep**.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**suspense pulse**, **low drone**, **distant metal**—generic.

**Style anchors:** *suspense thriller, hidden details, cold tension, claustrophobic framing, psychological unease, suspense_thriller_video.*
...
- Do **not** glorify **real violence** or **targeted harm**; keep **stylized fiction** tone.


### Example prompts

- `9:16 hallway—suspense_thriller_video, creeping push, cold teal grade, low drone`
- `Partial face in door crack—voyeur drift, psychological unease`
- `Parking garage pillar play—long lens pull, pulse bed`
- `Animate still—slow reveal (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `bright sitcom high key, wedding soft romance only, watermark` |
...
## Scenario: Text-to-video suspense thriller
...
## Scenario: Image-to-video suspense thriller
...
> Skill: `suspense-thriller-video-gen`.
