---
name: artistic-abstract-video-gen
version: 1.0.0
description: "Generate artistic abstract videos with WeryAI—surreal mood, blurred focus, symbolic composition, non-linear emotion for experimental and gallery-leaning pieces. Use when you need drift shots, rack-focus blur, irregular pan, double-exposure feel; experimental ambient or abstract soundscapes; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [abstract, surreal, experimental, art, non-linear, blur, symbolic, ambient, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Artistic abstract & surreal non-linear video

**Artistic abstract video** in one line: **metaphor over plot**, **soft focus islands**, **shadow grammar**, **looping gestures**—**dream logic**, not literal product demo.

**Style anchor tag (optional in user briefs):** `artistic_abstract_video`.

## Use when

- **Abstract cinematic**, **surreal mood**, **non-linear emotion**, **symbolic composition**.
- Text or **single image-to-video**.

**Not this skill:** **literal commercial CTA** clarity as default—unless user wants “abstract ad.”
...
- **Look & grade:** **intentional defocus**, **silhouette**, **color pools**, **grain**.
- **Camera grammar (pick 1–2):** **drift**; **rack blur**; **irregular pan**; **double-exposure feel** described in words.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**experimental** textures, **abstract soundscape**, sparse **tones**—generic.

**Style anchors:** *abstract cinematic, surreal mood, blurred focus, symbolic composition, non-linear emotion, artistic_abstract_video.*
...
- `Dream corridor drift—artistic_abstract_video, rack blur, symbolic shadows, abstract soundscape`
- `Double-exposure feel dancer—non-linear emotion, grain, experimental bed`
- `Color smoke pools—surreal mood, slow drift`
- `Animate painting still—blur push (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `literal infographic, sharp product callouts, watermark` |
...
## Scenario: Text-to-video artistic abstract
...
## Scenario: Image-to-video artistic abstract
...
> Skill: `artistic-abstract-video-gen`.
