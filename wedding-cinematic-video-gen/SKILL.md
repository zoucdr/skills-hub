...
**Wedding film video** in one line: **ritual gravity**, **family glances**, **veil micro-motion**, **soft specular on silk**, and **slow breath pacing**—**timeless**, not chaotic party montage unless requested.
...
**Not this skill:** **horror**, **glitch**, or **urban grit** as default—unless stylized brief.
...
- **Moments:** **aisle approach**, **ring exchange**, **first dance silhouette**—respect privacy; no real guest likeness without user consent context.
- **Camera grammar (pick 1–2):** **slow dolly**; **orbit during vows**; **long-lens follow** compression; describe **slow-motion feel** in prompt when user wants it (no separate API flag).
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**piano and strings** swell, **lyrical film underscore**—generic.
...
- Do **not** fabricate **real people** or **private events**; follow the user’s consent context for likeness-heavy wedding scenes.


### Example prompts

- `16:9 ceremony wide—wedding_cinematic_video, slow push, strings swell generic, soft highlights`
- `Veil macro—emotional elegance, slow-motion feel in prompt, piano motif`
- `First dance rim light—orbit, cinematic romance`
- `Animate ceremony still—long lens follow (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `horror grade, heavy glitch, muddy underexposure, watermark` |
