---
name: "fantasy-transform-video-gen-seedance2.0"
version: 1.0.0
description: "Transform any everyday scene, action, or subject into a fantastical, magical, ritual-rich vertical video using WeryAI Seedance 2.0 only. Use when you need festival wonder, fairy-tale spectacle, otherworldly glow, enchanted props, particle light, or ceremonial motion from a short brief or one HTTPS reference image. SEO: fantasy style video; magic transform short video."

tags: [fantasy, magic, stylization, festival, short-video, video-gen]

metadata: { "openclaw": { "emoji": "✨", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Fantasy & magic style transform (Seedance 2.0)
