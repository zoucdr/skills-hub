---
name: motion-graphics-explainer-video-gen
version: 1.0.0
description: "Generate motion graphics explainer videos with WeryAI—clean infographic look, animated typography, iconography, and efficient visual explanation for education and product storytelling. Use when you need layer slides, scale pops, path motion, virtual camera push on diagrams; corporate light electronic, narrator-rhythm beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [motion-graphics, explainer, infographic, typography, icons, corporate, education, UI, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Motion graphics & explanatory infographic video

**Motion graphics video** in one line: **grid discipline**, **icon morphs**, **kinetic type**, **stepped reveals**—**clarity**, not handheld vérité default.

**Style anchor tag (optional in user briefs):** `motion_graphics_explainer`.

## Use when

- **Motion graphics**, **infographic style**, **animated typography**, **explanatory visual system**.
- Text or **single image-to-video**.

**Not this skill:** **cinematic handheld drama** as default—unless “MG + live” hybrid.
...
- **Look & grade:** **flat vector** feel, **brand-safe** solids (user colors), **chart growth** metaphor.
- **Motion / camera:** **slide layers**; **scale pop** on bullets; **path animation** for connectors; **virtual push** into diagram.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**corporate light electronic**, **click** UI SFX, **steady pulse** for steps—generic.

**Style anchors:** *motion graphics, clean infographic style, animated typography, explanatory visual system, motion_graphics_explainer.*
...
- `9:16 three-step funnel MG—motion_graphics_explainer, icon morphs, corporate electronic bed`
- `Kinetic type headline—animated typography, grid snap SFX`
- `Chart rising bars—explanatory visual system, virtual push`
- `Animate logo still—clean infographic motion (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `shaky handheld doc, film grain heavy, watermark` |
...
## Scenario: Text-to-video motion graphics explainer
...
## Scenario: Image-to-video motion graphics explainer
...
> Skill: `motion-graphics-explainer-video-gen`.
