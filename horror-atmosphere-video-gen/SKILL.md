---
name: horror-atmosphere-video-gen
version: 1.0.0
description: "Generate horror atmosphere videos with WeryAI—eerie shadows, decayed texture, unsettling silence pockets, and fear tension for spooky and thriller-adjacent content. Use when you need slow exploration, sudden push, unstable handheld, peering angles; horror ambient, noise beds, jump-scare-adjacent SFX; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [horror, dread, shadows, eerie, scary, ambient, noise, dark, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Horror atmosphere & eerie dread video

**Horror atmosphere video** in one line: **dirty color** (sick green, cold blue, or desat), **negative space monsters**, **sound voids**, **micro tremor**—**dread**, not gore porn unless user explicitly requests stylized restraint.

**Style anchor tag (optional in user briefs):** `horror_atmosphere_video`.

## Use when

- **Horror atmosphere**, **eerie shadows**, **fear tension**, **decayed texture**.
- Text or **single image-to-video**.

**Not this skill:** **clean tech keynote** or **romantic wedding soft** as default.
...
- **Look & grade:** **underexposure**, **flicker practical**, **fog**, **grime**.
- **Camera grammar (pick 1–2):** **slow exploration**; **snap push** on beat; **handheld wobble**; **peephole** framing.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**horror ambient**, **radio static** texture, **single violin** screech sparse—generic SFX, no copyrighted stings.

**Style anchors:** *horror atmosphere, eerie shadows, unsettling silence, decayed texture, fear tension, horror_atmosphere_video.*
...
- Do **not** depict **graphic gore** or **real-person torture**; keep **PG-13 suggestive dread** unless user explicitly confirms mature stylized horror and platform rules.


### Example prompts

- `Basement slow pan—horror_atmosphere_video, sick green cast, unstable handheld, horror ambient bed`
- `Door creak off-screen—sudden push, noise texture SFX generic`
- `Fog corridor—decayed texture, dread`
- `Animate creepy still—peering angle (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `bright commercial, wedding glow, watermark` |
...
## Scenario: Text-to-video horror atmosphere
...
## Scenario: Image-to-video horror atmosphere
...
> Skill: `horror-atmosphere-video-gen`.
