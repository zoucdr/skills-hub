---
name: slow-emotional-video-gen
version: 1.0.0
description: "Generate slow emotional videos with WeryAI—poetic motion, soft light, lingering detail on hair, fabric, and breeze for introspective moods. Use when you need ultra-slow push/pull, long-lens compression, detail ECU; piano, strings, or ambient emotional beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [slow, emotional, poetic, introspective, piano, strings, cinematic, portrait, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Slow emotional & introspective cinematic video

**Slow emotional video** in one line: **held breath pacing**, **dust in beam**, **hair and cloth micro-motion**, **shy eye-line**—**introspection**, not hype sports.

**Style anchor tag (optional in user briefs):** `slow_emotional_video`.

## Use when

- **Slow emotional**, **poetic motion**, **introspective cinematic mood**, **lingering detail**.
- Text or **single image-to-video**.

**Not this skill:** **fast whip-cut street** default or **loud trap sports**—unless hybrid.
...
- **Look & grade:** **soft window**, **haze**, **lens bloom** subtle.
- **Camera grammar (pick 1–2):** **micro push**; **slow pull** revealing space; **long lens** compression on face.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**solo piano**, **string pad**, **ambient emotional** drone—generic.

**Style anchors:** *slow emotional, poetic motion, soft light, lingering detail, introspective cinematic mood, slow_emotional_video.*
...
- `9:16 window rain—slow_emotional_video, ultra-slow push, string pad, hair micro-motion`
- `Long lens portrait—lingering detail, soft light, piano motif`
- `Fabric in breeze—slow pull, introspective mood`
- `Animate still—poetic motion (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `fast urban whip cuts, loud EDM, watermark` |
...
## Scenario: Text-to-video slow emotional
...
## Scenario: Image-to-video slow emotional
...
> Skill: `slow-emotional-video-gen`.
