---
name: chinese-aesthetic-video-gen
version: 1.0.0
description: "Generate Chinese aesthetic videos with WeryAI—eastern negative space, flowing costume, bamboo, lanterns, ink-toned palette for hanfu, tea, and classical mood pieces. Use when you need slow lateral pan, orbit around figure, curtain foreground reveal, combined tilt; guzheng, xiao, dizi, or traditional ensemble beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [chinese, traditional, hanfu, ink, bamboo, lantern, elegant, eastern, guzheng, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Chinese aesthetic & poetic eastern mood video

**Chinese aesthetic video** in one line: **breathing negative space**, **silk motion**, **wind in bamboo**, **warm lantern pools** against **ink-wash hills**—**poetic east**, not generic neon city.

**Style anchor tag (optional in user briefs):** `chinese_aesthetic_video`.

## Use when

- **Chinese aesthetic**, **elegant traditional mood**, **ink tone**, **flowing costume**, **poetic eastern composition**.
- Text or **single image-to-video**.

**Not this skill:** **Western neon cyberpunk** default or **modern glass office only**—unless fusion brief.
...
- **Look & grade:** **muted jade**, **cinnabar accent**, **rice-paper** softness; **misty mountains** silhouette.
- **Props:** **lantern**, **tea steam**, **scroll**, **bamboo slats**—generic; follow user sensitivity notes for sacred or cultural context.
- **Camera grammar (pick 1–2):** **slow lateral** along pavilion; **orbit** with **veil foreground**; **tilt** from feet to face.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**guzheng** pluck, **xiao** breath, **ensemble traditional** pad—generic, no named commercial tracks.

**Style anchors:** *chinese aesthetic, elegant traditional mood, ink tone, flowing costume, poetic eastern composition, chinese_aesthetic_video.*
...
- Treat **cultural elements** respectfully; avoid **stereotype mockery**.


### Example prompts

- `16:9 misty pavilion—chinese_aesthetic_video, slow pan, ink tone, guzheng bed generic`
- `Hanfu sleeve wind—orbit, lantern bokeh, flowing costume`
- `Tea steam macro—poetic eastern composition, xiao pad`
- `Animate portrait still—bamboo foreground drift (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `cyberpunk neon default, harsh western noon only, watermark` |
...
## Scenario: Text-to-video Chinese aesthetic
...
## Scenario: Image-to-video Chinese aesthetic
...
> Skill: `chinese-aesthetic-video-gen`.
