---
name: post-apocalyptic-anime-video-gen
version: 1.0.0
description: "Bleak post-apocalyptic anime vistas—ruined skylines, dust, lonely survivors, and wide-empty vertical frames. Use when you need wasteland treks, crashed mechs **generic**, or motion from ruin concept art; expand briefs before submit. Paid API; **VIDU_Q3** for **dust** **scale**; **KLING_V3_0_STA** **survivor** **audio** drama; **GROK** **silent** **wasteland** thumbnails."

tags: [anime, post-apocalyptic, wasteland, ruins, survival, vertical, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Post-apocalyptic anime vertical video

**Post-apocalyptic anime** in one line: **ochre dust**, **skeleton buildings**, **single figure scale**, **wind** as time.

**Style anchor:** `post apocalyptic anime, ruined city, desolate landscape, lonely survivor, dust and decay`.

## Use when

- **Highway** crack weeds, **overpass** camp, **rusted** vehicle **generic**.
- Text or **single image-to-video**.

**Not this skill:** **cheerful school festival** default.

**Models:** tiered—**Vidu Q3** (default best), **Kling 3.0** (good), **Grok Imagine** (fast draft). See frozen table for JSON field rules.
...
- **Look / materials / VFX (genre):**
  - **Palette:** dusty yellow-gray with cold sky slice.
  - **Details:** torn banners **generic**, drifting ash, plastic flutter **stylized**.
  - **Figure:** small against wreckage—hope or exhaustion **user-chosen**.
- **Camera / motion / 9:16 framing (genre):**
  - **Moves:** wide pull-back reveal, slow follow behind walk, lateral drift past rubble.
  - **Framing:** **9:16**—vertical towers broken; horizon low for heaviness.
...
- **Negative prompt:** Optional **Kling** `negative_prompt`: `clean futuristic utopia, bright festival, watermark`.
...
- `9:16` survivor walk—ruined towers, dust wind, pull back, low synth + wind
- Overpass camp—ember spark, slow pan
- Image-to-video: wasteland art → dust drift + cloth flap
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `VIDU_Q3` | 10 | **Vidu Q3**—**ruin** detail + **wind** audio. |
| 👍 Good | `KLING_V3_0_STA` | 10 | **Kling Standard**—**character** focus. |
| ⚡ Fast | `GROK_IMAGINE_VIDEO` | 10 | **Grok**—fast **wide** shots; **no audio**. |
...
> Skill: `post-apocalyptic-anime-video-gen`.
