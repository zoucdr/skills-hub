---
name: "surreal-mutation-transform-video-gen-seedance2.0"
version: 1.0.0
description: "Break reality for scroll-stopping shorts: warped space, wrong-scale objects, surprise morph payoffs—WeryAI Seedance 2.0 only. Use when you need weird bait, glitch-dream transitions, or surreal product hooks. SEO: surreal video; weird transform short video."

tags: [surreal, weird, experimental, viral, short-video, video-gen]

metadata: { "openclaw": { "emoji": "🫧", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Surreal mutation & impossible physics (Seedance 2.0)

**Anti-physics storytelling:** gravity tilts, rooms fold, materials swap mid-action, scale jokes land as clear visual punchlines.
...
- **Rule breaks:** melting clocks vibe, impossible stairs, duplicate reflections.
- **Space warp:** corridor stretch, sky on floor—one clear hero idea per clip.
- **Materials:** liquid metal, rubber stone—motivated by user beat.
- **Scale play:** giant hand, tiny city—readable silhouette.
- **Motion payoff:** expectation subversion in final third of timeline.
- **Sound (if on):** reversed whooshes, rubbery boings—sparse and odd.

**Fits:** Curiosity bait, contrast comedy, visual spectacle, pattern-interrupt ads.
...
- `Drinking coffee → cup becomes miniature swimming pool, diver splash gag, vertical`
- `Walking upstairs → steps melt into waterfall, seamless dream logic`
- `HTTPS sneaker → sole grows into slide, surreal playground`
...
> Generated for skill `surreal-mutation-transform-video-gen-seedance2.0`.
