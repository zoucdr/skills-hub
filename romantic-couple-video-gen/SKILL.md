---
name: romantic-couple-video-gen
version: 1.0.0
description: "Generate romantic couple videos with WeryAI—intimate gestures, soft warm or creamy light, dreamy atmosphere for dating, save-the-date, and couple shorts. Use when you need dual orbit, stroll follow, gentle push on hands, slow backlit drift; piano, acoustic love, or soft pop beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [romantic, couple, love, wedding-prep, soft-light, intimate, dreamy, portrait, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Romantic couple & dreamy love-story video

**Romantic couple video** in one line: **eye-line**, **hands**, **smile micro-timing**, **cream or golden haze**, and **shallow depth**—**tender**, not edgy fashion default.

**Style anchor tag (optional in user briefs):** `romantic_couple_video`.

## Use when

- **Romantic couple**, **intimate gestures**, **soft warm light**, **dreamy emotional atmosphere**, **pre-wedding** vibe.
- Text or **single image-to-video**.

**Not this skill:** **horror tension**, **high-contrast street grit** primary, or **product macro** focus—unless hybrid requested.
...
- **Look & grade:** **warm key**, **soft fill**, **bloom** on highlights; optional **golden hour**.
- **Blocking:** **forehead lean**, **interlaced fingers**, **walk in step**.
- **Camera grammar (pick 1–2):** **dual orbit**; **stroll follow** side by side; **gentle ECU push** on ring or hands; **slow drift** in backlight.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**solo piano**, **fingerpicked acoustic**, **soft love-song bed** instrumental—generic.

**Style anchors:** *romantic couple, intimate gestures, soft warm light, dreamy emotional atmosphere, romantic_couple_video.*

**Length:** ≤ **2000**.

**Confirmation:** **full** expanded `prompt` in pre-submit.
...
- `9:16 golden hour stroll—romantic_couple_video, dual orbit, creamy haze, piano motif generic`
- `Forehead touch ECU—gentle push, soft warm light, acoustic bed`
- `Hands interlaced—slow drift, dreamy atmosphere`
- `Animate engagement photo—stroll follow (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `horror shadows, harsh flash, gritty street only, watermark` |
...
## Scenario: Text-to-video romantic couple
...
## Scenario: Image-to-video romantic couple
...
> Skill: `romantic-couple-video-gen`.
