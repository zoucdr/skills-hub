---
name: anime-cel-style-video-gen
version: 1.0.0
description: "Generate anime cel–style videos with WeryAI—clean edge read, designed color blocks, dynamic manga framing for character-forward and fantasy action moods. Use when you need panel-style push, dramatic low angle, speed-line motion, hard cuts; anime score, J-rock, or hot-blood electronic beds; expand short briefs before submit. Paid API; default KLING_V3_0_PRO, draft SEEDANCE_2_0."

tags: [anime, cel-shading, manga, stylized, J-rock, character, fantasy-action, text-to-video, image-to-video, video-gen]

metadata: { "openclaw": { "emoji": "🎬", "primaryEnv": "WERYAI_API_KEY", "paid": true, "network_required": true, "requires": { "env": ["WERYAI_API_KEY"], "bins": ["node"], "node": ">=18" } } }
user-invocable: true
---

# Anime cel style & bold manga-energy video

**Anime cel video** in one line: **hard color separation**, **ink-outline feel**, **exaggerated perspective**, **impact frames**—**stylized 2.5D**, not photoreal default.

**Style anchor tag (optional in user briefs):** `anime_cel_style_video`.

## Use when

- **Anime cel shading**, **stylized edge**, **vivid emotional framing**, **dynamic manga energy**.
- Text or **single image-to-video**.

**Not this skill:** **muted documentary realism** primary—unless user wants “real actors cosplay” hybrid.
...
- **Look & grade:** **flat fills**, **rim anime light**, **speed lines** language, **big eyes** styling only if user wants—avoid copying specific franchise characters.
- **Camera grammar (pick 1–2):** **dramatic low angle**; **snap push**; **panel-to-panel** cut rhythm described.
- **Audio (mandatory when `generate_audio` is true):** **`Audio:`**—**anime battle strings**, **J-rock** drive, **hot-blood synth**—generic.

**Style anchors:** *anime cel shading, stylized edge, vivid emotional framing, dynamic manga energy, anime_cel_style_video.*
...
- Do **not** copy **named anime IP** or **copyrighted characters** unless user confirms rights; use **original** or **generic** descriptors.


### Example prompts

- `Cel-shaded rooftop duel—anime_cel_style_video, speed-line motion, J-rock bed generic`
- `Low-angle hero pose—dynamic manga energy, hard cut rhythm`
- `Magic slash streak—vivid emotional framing, anime score pad`
- `Animate OC still—cel edge lighting (image URL)`
...
|------|-----------|------------------|--------|
| ⭐ Best (default) | `KLING_V3_0_PRO` | 10 (use **15** for slower arcs) | **Omit `resolution`.** Optional **`negative_prompt`** e.g. `photoreal skin pores default, documentary gray, watermark` |
...
## Scenario: Text-to-video anime cel style
...
## Scenario: Image-to-video anime cel style
...
> Skill: `anime-cel-style-video-gen`.
