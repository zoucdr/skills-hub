...
Parent skill: [SKILL.md](../SKILL.md). This file is the **entry point**; deep content lives in sibling docs under **`references/`** so you can jump straight to what you need.
